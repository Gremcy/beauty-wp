...
class Meta {
    ...
    private function get_seo($what){
        ...
        elseif(is_page('school')){
            ...
            // return
            if($section){
                $default = ($what=='title' ? ($section === 'masters' ? get_field('title_1') : get_field('title_2')) . $this->separator . get_the_title() . $this->separator . $this->blogname : '');
            }else{
                $default = ($what=='title' ? get_the_title() . $this->separator . $this->blogname : '');
            }
