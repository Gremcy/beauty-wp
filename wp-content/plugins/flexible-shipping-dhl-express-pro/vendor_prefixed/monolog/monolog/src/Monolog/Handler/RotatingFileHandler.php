 ...
 */
class RotatingFileHandler extends \FlexibleShippingDhlExpressProVendor\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct($filename, $maxFiles = 0, $level = \FlexibleShippingDhlExpressProVendor\Monolog\Logger::DEBUG, $bubble = \true, $filePermission = null, $useLocking = \false)
    {
        $this->filename = \FlexibleShippingDhlExpressProVendor\Monolog\Utils::canonicalizePath($filename);
