 ...
 */
abstract class AbstractHandler implements \FlexibleShippingDhlExpressProVendor\Monolog\Handler\HandlerInterface, \FlexibleShippingDhlExpressProVendor\Monolog\ResettableInterface
{
    protected $level = \FlexibleShippingDhlExpressProVendor\Monolog\Logger::DEBUG;
    ...
    {
        $this->level = \FlexibleShippingDhlExpressProVendor\Monolog\Logger::toMonologLevel($level);
        return $this;
    }
    /**
