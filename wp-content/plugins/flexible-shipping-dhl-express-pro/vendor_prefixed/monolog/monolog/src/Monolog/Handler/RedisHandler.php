 ...
 */
class RedisHandler extends \FlexibleShippingDhlExpressProVendor\Monolog\Handler\AbstractProcessingHandler
{
    private $redisClient;
    private $redisKey;
    protected $capSize;
     ...
     */
    public function __construct($redis, $key, $level = \FlexibleShippingDhlExpressProVendor\Monolog\Logger::DEBUG, $bubble = \true, $capSize = \false)
    {
        if (!($redis instanceof \FlexibleShippingDhlExpressProVendor\Predis\Client || $redis instanceof \Redis)) {
