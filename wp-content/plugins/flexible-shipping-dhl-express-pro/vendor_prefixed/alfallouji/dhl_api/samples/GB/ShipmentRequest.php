 ...
 * @version     0.1
 */
use FlexibleShippingDhlExpressProVendor\DHL\Entity\GB\ShipmentResponse;
use FlexibleShippingDhlExpressProVendor\DHL\Entity\GB\ShipmentRequest;
use FlexibleShippingDhlExpressProVendor\DHL\Client\Web as WebserviceClient;
use FlexibleShippingDhlExpressProVendor\DHL\Datatype\GB\Piece;
use FlexibleShippingDhlExpressProVendor\DHL\Datatype\GB\SpecialService;
require __DIR__ . '/../../init.php';
// DHL Settings
$dhl = $config['dhl'];
// Test a ShipmentRequestRequest using DHL XML API
$sample = new \FlexibleShippingDhlExpressProVendor\DHL\Entity\GB\ShipmentRequest();
...
$piece = new \FlexibleShippingDhlExpressProVendor\DHL\Datatype\GB\Piece();
$piece->PieceID = '1';
...
$specialService = new \FlexibleShippingDhlExpressProVendor\DHL\Datatype\GB\SpecialService();
...
$start = \microtime(\true);
echo $sample->toXML();
$client = new \FlexibleShippingDhlExpressProVendor\DHL\Client\Web('staging');
$xml = $client->call($sample);
echo \PHP_EOL . 'Executed in ' . (\microtime(\true) - $start) . ' seconds.' . \PHP_EOL;
$response = new \FlexibleShippingDhlExpressProVendor\DHL\Entity\GB\ShipmentResponse();
