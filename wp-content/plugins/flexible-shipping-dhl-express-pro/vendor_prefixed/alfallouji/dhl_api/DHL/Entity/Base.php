 ...
 * @version     0.1
 */
namespace FlexibleShippingDhlExpressProVendor\DHL\Entity;

use FlexibleShippingDhlExpressProVendor\DHL\Datatype\Base as BaseDataType;
/**
 * Abstract class for each entity model used by DHL
 */
abstract class Base extends \FlexibleShippingDhlExpressProVendor\DHL\Datatype\Base
{
    /**
     * Property values bag
     * @var array
     ...
     * @var array
     */
    protected $_headerParams = array('MessageTime' => array('type' => 'date-iso8601', 'required' => \true), 'MessageReference' => array('type' => 'string', 'required' => \true, 'size' => 28), 'SiteID' => array('type' => 'string', 'required' => \true), 'Password' => array('type' => 'string', 'required' => \true));
    /**
    ...
    {
        foreach ($this->_params as $name => $infos) {
            if (isset($infos['required']) && \true === $infos['required'] && $this->_values[$name] === null) {
