 ...
 * @version     0.1
 */
namespace FlexibleShippingDhlExpressProVendor\DHL\Client;

use FlexibleShippingDhlExpressProVendor\DHL\Entity\Base as Request;
/**
...
class Web
{
     ...
     */
    public function call(\FlexibleShippingDhlExpressProVendor\DHL\Entity\Base $request)
    {
        if (!($ch = \curl_init())) {
