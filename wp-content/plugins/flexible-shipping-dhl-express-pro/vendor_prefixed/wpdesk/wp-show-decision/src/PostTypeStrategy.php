...
namespace FlexibleShippingDhlExpressProVendor\WPDesk\ShowDecision;

/**
 * Show when pages associated with given post type is displayed.
 */
class PostTypeStrategy implements \FlexibleShippingDhlExpressProVendor\WPDesk\ShowDecision\ShouldShowStrategy
{
    /** @var string */
    private $post_type;
