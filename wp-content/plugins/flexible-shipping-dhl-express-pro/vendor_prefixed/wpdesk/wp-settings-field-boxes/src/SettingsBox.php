 ...
 */
class SettingsBox extends \FlexibleShippingDhlExpressProVendor\WpDesk\WooCommerce\ShippingMethod\AbstractBox implements \JsonSerializable
{
    ...
    {
        $box = new \FlexibleShippingDhlExpressProVendor\WpDesk\WooCommerce\ShippingMethod\SettingsBox();
