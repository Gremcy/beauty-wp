 ...
 */
class BuiltInBox extends \FlexibleShippingDhlExpressProVendor\WpDesk\WooCommerce\ShippingMethod\AbstractBox implements \JsonSerializable
{
    /**
     ...
     * @return BuiltInBox
     */
    public static function create_from_code_and_packer_box($code, \FlexibleShippingDhlExpressProVendor\WPDesk\Packer\Box $packer_box)
    {
        $box = new self();
        $box->set_code($code);
