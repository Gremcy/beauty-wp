...
namespace FlexibleShippingDhlExpressProVendor\WPDesk\License\Changelog;

use ArrayObject;
use FlexibleShippingDhlExpressProVendor\WPDesk\License\Changelog\Parser\Line;
/**
 * Can parse changelog.
 *
...
class Parser
{
    ...
    private function get_lines()
    {
        ...
        return \array_map(function ($line) {
            return new \FlexibleShippingDhlExpressProVendor\WPDesk\License\Changelog\Parser\Line($line);
