 ...
 */
class PluginsPageRenderer implements \FlexibleShippingDhlExpressProVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    /**
    ...
    public function output_render(string $plugin_file, $plugin_data)
    {
        ...
        $form_content = new \FlexibleShippingDhlExpressProVendor\WPDesk\License\ActivationForm\Renderer($this->plugin_info, $update_possible);
