...
namespace FlexibleShippingDhlExpressProVendor\WPDesk\License\ActivationForm;

use FlexibleShippingDhlExpressProVendor\WPDesk\License\LicenseManager;
use FlexibleShippingDhlExpressProVendor\WPDesk\License\Page\LicensePageActions;
use FlexibleShippingDhlExpressProVendor\WPDesk\License\PluginLicense;
 ...
 */
class AjaxHandler implements \FlexibleShippingDhlExpressProVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    ...
    public function handle_ajax_action()
    {
        ...
        $license_manager = new \FlexibleShippingDhlExpressProVendor\WPDesk\License\LicenseManager($this->plugin_info);
        ...
        $license_page_action = (new \FlexibleShippingDhlExpressProVendor\WPDesk\License\Page\LicensePageActions())->create_action($license_action, \false);
        ...
        $plugin_license = new \FlexibleShippingDhlExpressProVendor\WPDesk\License\PluginLicense($this->plugin_info);
        $form_content_renderer = new \FlexibleShippingDhlExpressProVendor\WPDesk\License\ActivationForm\FormContentRenderer($this->plugin_info, $this->is_update_possible(isset($update_plugins[$this->plugin_info->get_plugin_file_name()]) ?? new \stdClass()), $license_page_action->get_errors());
