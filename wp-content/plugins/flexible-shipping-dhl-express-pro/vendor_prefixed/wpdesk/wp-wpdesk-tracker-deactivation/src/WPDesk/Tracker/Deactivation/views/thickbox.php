...
?>" style="display:none;">
	<h2><?php 
echo \sprintf(\__('You are deactivating %s plugin.', 'flexible-shipping-dhl-express-pro'), $plugin_title);
?></h2>
...
?>">
		<div class="body">
			...
			<div class="panel active" data-panel-id="reasons">
				<h4><strong><?php 
\_e('If you have a moment, please let us know why you are deactivating the plugin (anonymous feedback):', 'flexible-shipping-dhl-express-pro');
?></strong></h4>
				<ul class="reasons-list">
					<li class="reason">
						<label>
							...
							<span><?php 
\_e('The plugin suddenly stopped working', 'flexible-shipping-dhl-express-pro');
?></span>
						</label>
					</li>
					<li class="reason">
						<label>
							...
							<span><?php 
\_e('The plugin broke my site', 'flexible-shipping-dhl-express-pro');
?></span>
						</label>
					</li>
					<li class="reason has-input">
						<label>
							...
							<span><?php 
\_e('I have found a better plugin', 'flexible-shipping-dhl-express-pro');
?></span>
						</label>
...
\_e('What\'s the plugin\'s name?', 'flexible-shipping-dhl-express-pro');
?>">
						</div>
					</li>
					<li class="reason">
						<label>
						    ...
						    <span><?php 
\_e('I only needed the plugin for a short period', 'flexible-shipping-dhl-express-pro');
?></span>
						</label>
					</li>
					<li class="reason">
						<label>
							...
							<span><?php 
\_e('I no longer need the plugin', 'flexible-shipping-dhl-express-pro');
?></span>
						</label>
					</li>
					<li class="reason">
						<label>
                            ...
                            <span><?php 
\_e('It\'s a temporary deactivation. I\'m just debugging an issue.', 'flexible-shipping-dhl-express-pro');
?></span>
						</label>
					</li>
					<li class="reason has-input">
						<label>
						    ...
						    <span><?php 
\_e('Other', 'flexible-shipping-dhl-express-pro');
?></span>
						</label>
						<div class="other" class="reason-input" style="display: none">
							<input type="text" name="other" class="additional-info" placeholder="<?php 
\_e('Please let us know how we can improve our plugin', 'flexible-shipping-dhl-express-pro');
?>">
						</div>
					</li>
				</ul>
...
\_e('Cancel', 'flexible-shipping-dhl-express-pro');
?></a>
			<a href="#" class="button button-primary button-deactivate allow-deactivate"><?php 
\_e('Skip &amp; Deactivate', 'flexible-shipping-dhl-express-pro');
?></a>
		</div>
	</div>
</div><?php 
