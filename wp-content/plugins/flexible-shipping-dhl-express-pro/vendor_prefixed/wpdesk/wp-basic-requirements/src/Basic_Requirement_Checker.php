...
if (!\interface_exists('FlexibleShippingDhlExpressProVendor\\WPDesk_Requirement_Checker')) {
...
if (!\class_exists('FlexibleShippingDhlExpressProVendor\\WPDesk_Basic_Requirement_Checker')) {
     ...
     */
    class WPDesk_Basic_Requirement_Checker implements \FlexibleShippingDhlExpressProVendor\WPDesk_Requirement_Checker
    {
