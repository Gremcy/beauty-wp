 ...
 */
class ChainResolver implements \FlexibleShippingDhlExpressProVendor\WPDesk\View\Resolver\Resolver
{
    /** @var Resolver[] */
    private $resolvers;
    /**
    ...
    public function resolve($name, \FlexibleShippingDhlExpressProVendor\WPDesk\View\Renderer\Renderer $renderer = null)
    {
        foreach ($this->resolvers as $resolver) {
            ...
            } catch (\FlexibleShippingDhlExpressProVendor\WPDesk\View\Resolver\Exception\CanNotResolve $e) {
                // not interested
            }
        }
        throw new \FlexibleShippingDhlExpressProVendor\WPDesk\View\Resolver\Exception\CanNotResolve("Cannot resolve {$name}");
    }
}
