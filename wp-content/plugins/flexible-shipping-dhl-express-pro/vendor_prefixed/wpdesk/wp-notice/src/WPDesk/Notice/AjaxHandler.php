...
namespace FlexibleShippingDhlExpressProVendor\WPDesk\Notice;

use FlexibleShippingDhlExpressProVendor\WPDesk\PluginBuilder\Plugin\HookablePluginDependant;
use FlexibleShippingDhlExpressProVendor\WPDesk\PluginBuilder\Plugin\PluginAccess;
/**
 * Class AjaxHandler
 *
 ...
 */
class AjaxHandler implements \FlexibleShippingDhlExpressProVendor\WPDesk\PluginBuilder\Plugin\HookablePluginDependant
{
    use PluginAccess;
    ...
    public function processAjaxNoticeDismiss()
    {
        if (isset($_POST[self::POST_FIELD_NOTICE_NAME])) {
            ...
            \update_option(\FlexibleShippingDhlExpressProVendor\WPDesk\Notice\PermanentDismissibleNotice::OPTION_NAME_PREFIX . $noticeName, \FlexibleShippingDhlExpressProVendor\WPDesk\Notice\PermanentDismissibleNotice::OPTION_VALUE_DISMISSED);
