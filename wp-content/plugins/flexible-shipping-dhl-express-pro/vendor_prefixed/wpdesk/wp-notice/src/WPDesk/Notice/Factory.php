...
class Factory
{
    ...
    {
        return new \FlexibleShippingDhlExpressProVendor\WPDesk\Notice\Notice($noticeContent, $noticeType, $isDismissible, $priority);
    }
    /**
    ...
    {
        return new \FlexibleShippingDhlExpressProVendor\WPDesk\Notice\PermanentDismissibleNotice($noticeContent, $noticeName, $noticeType, $priority);
    }
}
