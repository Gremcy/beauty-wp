...
if (!\interface_exists('FlexibleShippingDhlExpressProVendor\\WPDesk_Buildable')) {
    require_once __DIR__ . '/Buildable.php';
}
if (!\interface_exists('FlexibleShippingDhlExpressProVendor\\WPDesk_Has_Plugin_Info')) {
 ...
 */
class WPDesk_Plugin_Info implements \FlexibleShippingDhlExpressProVendor\WPDesk_Translatable, \FlexibleShippingDhlExpressProVendor\WPDesk_Buildable, \FlexibleShippingDhlExpressProVendor\WPDesk_Has_Plugin_Info
{
    /** @var string */
