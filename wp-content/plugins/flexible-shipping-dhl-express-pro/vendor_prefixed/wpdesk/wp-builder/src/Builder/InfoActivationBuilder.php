...
namespace FlexibleShippingDhlExpressProVendor\WPDesk\PluginBuilder\Builder;
...
use FlexibleShippingDhlExpressProVendor\WPDesk\PluginBuilder\Storage\PluginStorage;
/**
 ...
 */
class InfoActivationBuilder extends \FlexibleShippingDhlExpressProVendor\WPDesk\PluginBuilder\Builder\AbstractBuilder
{
     ...
     */
    public function __construct(\FlexibleShippingDhlExpressProVendor\WPDesk_Buildable $info, $is_active)
    {
        $this->info = $info;
    ...
    public function build_plugin()
    {
        ...
        if ($this->plugin instanceof \FlexibleShippingDhlExpressProVendor\WPDesk\PluginBuilder\Plugin\ActivationAware && $this->is_active) {
            $this->plugin->set_active();
        }
        return $this->plugin;
    }
    public function store_plugin(\FlexibleShippingDhlExpressProVendor\WPDesk\PluginBuilder\Storage\PluginStorage $storage)
    {
