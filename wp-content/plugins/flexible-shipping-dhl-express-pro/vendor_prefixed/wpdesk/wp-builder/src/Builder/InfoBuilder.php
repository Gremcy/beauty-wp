 ...
 */
class InfoBuilder extends \FlexibleShippingDhlExpressProVendor\WPDesk\PluginBuilder\Builder\AbstractBuilder
{
    ...
    public function __construct(\FlexibleShippingDhlExpressProVendor\WPDesk_Buildable $info)
    {
        $this->info = $info;
