 ...
 */
namespace FlexibleShippingDhlExpressProVendor\WPDesk\AbstractShipping\Settings;
...
abstract class SettingsDefinition
{
     ...
     * @return bool
     */
    public abstract function validate_settings(\FlexibleShippingDhlExpressProVendor\WPDesk\AbstractShipping\Settings\SettingsValues $settings);
    /**
     * Get settings.
     *
     * @return array
