...
class CurrencySwitcherException extends \RuntimeException
{
    ...
    public function __construct(\FlexibleShippingDhlExpressProVendor\WPDesk\AbstractShipping\Shop\ShopSettings $shop_settings)
    {
        ...
        $message = \sprintf(\__('Multicurrency is supported by %1$sFlexible Shipping DHL Express PRO →%2$s', 'flexible-shipping-dhl-express-pro'), '<a href="' . \esc_url($pro_link) . '" target="_blank">', '</a>');
