...
class CollectionPointFormatter
{
     ...
     * @return string
     */
    public function get_collection_point_as_label(\FlexibleShippingDhlExpressProVendor\WPDesk\AbstractShipping\CollectionPoints\CollectionPoint $collection_point)
    {
