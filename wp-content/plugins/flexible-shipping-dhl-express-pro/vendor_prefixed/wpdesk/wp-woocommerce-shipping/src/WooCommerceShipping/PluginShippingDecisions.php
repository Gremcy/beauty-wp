...
class PluginShippingDecisions
{
     ...
     *
     */
    public function __construct(\FlexibleShippingDhlExpressProVendor\WPDesk\AbstractShipping\ShippingService $service, \Psr\Log\LoggerInterface $logger)
    {
     ...
     */
    public function set_field_api_status_ajax(\FlexibleShippingDhlExpressProVendor\WPDesk\WooCommerceShipping\CustomFields\ApiStatus\FieldApiStatusAjax $field_api_status_ajax)
    {
