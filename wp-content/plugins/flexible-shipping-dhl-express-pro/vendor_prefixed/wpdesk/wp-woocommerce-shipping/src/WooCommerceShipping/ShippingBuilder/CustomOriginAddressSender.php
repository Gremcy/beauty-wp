 ...
 * @package WPDesk\ShippingBuilder\Address
 */
class CustomOriginAddressSender implements \FlexibleShippingDhlExpressProVendor\WPDesk\WooCommerceShipping\ShippingBuilder\AddressProvider
{
    /**
     * @var Address;
     */
    ...
    {
        $this->sender_address = new \FlexibleShippingDhlExpressProVendor\WPDesk\AbstractShipping\Shipment\Address();
