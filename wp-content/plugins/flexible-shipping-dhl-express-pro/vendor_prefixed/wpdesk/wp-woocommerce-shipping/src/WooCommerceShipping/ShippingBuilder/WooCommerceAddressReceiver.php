 ...
 * @package WPDesk\ShippingBuilder\Address
 */
class WooCommerceAddressReceiver implements \FlexibleShippingDhlExpressProVendor\WPDesk\WooCommerceShipping\ShippingBuilder\AddressProvider
{
    /**
     * Package data.
     *
    ...
    {
        $address = new \FlexibleShippingDhlExpressProVendor\WPDesk\AbstractShipping\Shipment\Address();
