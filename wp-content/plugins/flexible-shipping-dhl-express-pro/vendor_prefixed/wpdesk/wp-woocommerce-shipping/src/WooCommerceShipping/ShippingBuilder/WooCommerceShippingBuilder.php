 ...
 */
namespace FlexibleShippingDhlExpressProVendor\WPDesk\WooCommerceShipping\ShippingBuilder;

use FlexibleShippingDhlExpressProVendor\WPDesk\AbstractShipping\Rate\Money;
use FlexibleShippingDhlExpressProVendor\WPDesk\AbstractShipping\Shipment\Client;
use FlexibleShippingDhlExpressProVendor\WPDesk\AbstractShipping\Shipment\Dimensions;
use FlexibleShippingDhlExpressProVendor\WPDesk\AbstractShipping\Shipment\Item;
...
class WooCommerceShippingBuilder
{
     ...
     */
    public function set_sender_address(\FlexibleShippingDhlExpressProVendor\WPDesk\WooCommerceShipping\ShippingBuilder\AddressProvider $sender_address)
    {
     ...
     */
    public function set_receiver_address(\FlexibleShippingDhlExpressProVendor\WPDesk\WooCommerceShipping\ShippingBuilder\AddressProvider $receiver_address)
    {
    ...
    protected function get_woocommerce_dimension_unit()
    {
        switch ($this->dimension_unit) {
            case 'mm':
                return \FlexibleShippingDhlExpressProVendor\WPDesk\AbstractShipping\Shipment\Dimensions::DIMENSION_UNIT_MM;
            case 'cm':
                return \FlexibleShippingDhlExpressProVendor\WPDesk\AbstractShipping\Shipment\Dimensions::DIMENSION_UNIT_CM;
            case 'm':
                return \FlexibleShippingDhlExpressProVendor\WPDesk\AbstractShipping\Shipment\Dimensions::DIMENSION_UNIT_M;
            case 'in':
                return \FlexibleShippingDhlExpressProVendor\WPDesk\AbstractShipping\Shipment\Dimensions::DIMENSION_UNIT_IN;
        }
    ...
    protected function get_woocommerce_weight_unit()
    {
        switch ($this->weight_unit) {
            case 'g':
                return \FlexibleShippingDhlExpressProVendor\WPDesk\AbstractShipping\Shipment\Weight::WEIGHT_UNIT_G;
            case 'kg':
                return \FlexibleShippingDhlExpressProVendor\WPDesk\AbstractShipping\Shipment\Weight::WEIGHT_UNIT_KG;
            case 'lb':
                return \FlexibleShippingDhlExpressProVendor\WPDesk\AbstractShipping\Shipment\Weight::WEIGHT_UNIT_LB;
        }
    ...
    {
        $item = new \FlexibleShippingDhlExpressProVendor\WPDesk\AbstractShipping\Shipment\Item();
        ...
        $item->declared_value = new \FlexibleShippingDhlExpressProVendor\WPDesk\AbstractShipping\Rate\Money();
    ...
    {
        $shipping_package = new \FlexibleShippingDhlExpressProVendor\WPDesk\AbstractShipping\Shipment\Package();
        $shipping_package->items = [];
        $package_weight = new \FlexibleShippingDhlExpressProVendor\WPDesk\AbstractShipping\Shipment\Weight();
    ...
    {
        $shipment = new \FlexibleShippingDhlExpressProVendor\WPDesk\AbstractShipping\Shipment\Shipment();
        $ship_from = new \FlexibleShippingDhlExpressProVendor\WPDesk\AbstractShipping\Shipment\Client();
        $ship_from->address = $this->sender_address->get_address();
        $ship_to = new \FlexibleShippingDhlExpressProVendor\WPDesk\AbstractShipping\Shipment\Client();
