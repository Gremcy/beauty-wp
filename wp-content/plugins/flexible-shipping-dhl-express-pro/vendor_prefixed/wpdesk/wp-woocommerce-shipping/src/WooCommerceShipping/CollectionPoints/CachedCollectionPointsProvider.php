 ...
 */
class CachedCollectionPointsProvider implements \FlexibleShippingDhlExpressProVendor\WPDesk\AbstractShipping\CollectionPointCapability\CollectionPointsProvider
{
    /**
     ...
     * @param string                   $salt .
     */
    public function __construct(\FlexibleShippingDhlExpressProVendor\WPDesk\AbstractShipping\CollectionPointCapability\CollectionPointsProvider $collection_points_provider, \FlexibleShippingDhlExpressProVendor\WPDesk\Persistence\PersistentContainer $persistent_container, $salt)
    {
     ...
     * @return string
     */
    private function get_address_as_string(\FlexibleShippingDhlExpressProVendor\WPDesk\AbstractShipping\Shipment\Address $address)
    {
