...
namespace FlexibleShippingDhlExpressProVendor\WPDesk\Persistence\Adapter\WordPress;
 ...
 */
final class WordpressPostMetaContainer implements \FlexibleShippingDhlExpressProVendor\WPDesk\Persistence\PersistentContainer
{
    ...
    public function get($key)
    {
        ...
        if (\count($meta) === 0) {
            throw new \FlexibleShippingDhlExpressProVendor\WPDesk\Persistence\ElementNotExistsException(\sprintf('Element %s not exists!', $key));
        }
        return $meta[0];
    }
    /**
