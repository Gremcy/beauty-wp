...
namespace FlexibleShippingDhlExpressProVendor\WPDesk\Persistence;
 ...
 */
interface DeferredPersistentContainer extends \FlexibleShippingDhlExpressProVendor\WPDesk\Persistence\PersistentContainer
{
    /**
     * Save changed data.
     *
