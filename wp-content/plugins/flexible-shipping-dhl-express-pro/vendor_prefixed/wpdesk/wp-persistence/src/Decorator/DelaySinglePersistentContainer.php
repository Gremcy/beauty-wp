...
use FlexibleShippingDhlExpressProVendor\WPDesk\Persistence\AllDataAccessContainer;
/**
 * You can use this class to delay write access to any PersistenceContainer and save it as single value.
 *
 * @package WPDesk\Persistence
 */
final class DelaySinglePersistentContainer extends \FlexibleShippingDhlExpressProVendor\WPDesk\Persistence\Decorator\DelayPersistentContainer implements \FlexibleShippingDhlExpressProVendor\WPDesk\Persistence\AllDataAccessContainer
{
    /**
     ...
     */
    private $key;
    public function __construct(\FlexibleShippingDhlExpressProVendor\WPDesk\Persistence\PersistentContainer $container, string $key)
    {
