...
if (!\class_exists('FlexibleShippingDhlExpressProVendor\\WPDesk_Logger')) {
    /**
    ...
    class WPDesk_Logger
    {
        ...
        {
            if (!self::$logger) {
                $loggerFactroy = new \FlexibleShippingDhlExpressProVendor\WPDesk\Logger\WPDeskLoggerFactory();
        ...
        {
            return ['disabled' => \__('Disabled', 'flexible-shipping-dhl-express-pro'), 'emergency' => \__('Emergency', 'flexible-shipping-dhl-express-pro'), 'alert' => \__('Alert', 'flexible-shipping-dhl-express-pro'), 'critical' => \__('Critical', 'flexible-shipping-dhl-express-pro'), 'error' => \__('Error', 'flexible-shipping-dhl-express-pro'), 'warning' => \__('Warning', 'flexible-shipping-dhl-express-pro'), 'notice' => \__('Notice', 'flexible-shipping-dhl-express-pro'), 'info' => \__('Info', 'flexible-shipping-dhl-express-pro'), 'debug' => \__('Debug', 'flexible-shipping-dhl-express-pro')];
        }
        /**
         * @param string $level
         * @param string $source
