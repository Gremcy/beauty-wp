...
use FlexibleShippingDhlExpressProVendor\Monolog\Handler\AbstractProcessingHandler;
use FlexibleShippingDhlExpressProVendor\Monolog\Logger;
/**
 * Class WooCommerceFactory
 */
class WooCommerceHandler extends \FlexibleShippingDhlExpressProVendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return \FlexibleShippingDhlExpressProVendor\Monolog\Logger::getLevelName($level);
    }
