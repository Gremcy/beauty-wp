...
namespace FlexibleShippingDhlExpressProVendor\WPDesk\Packer\Item;

use FlexibleShippingDhlExpressProVendor\WPDesk\Packer\Item;
class ItemImplementation implements \FlexibleShippingDhlExpressProVendor\WPDesk\Packer\Item
{
    /** @var float */
