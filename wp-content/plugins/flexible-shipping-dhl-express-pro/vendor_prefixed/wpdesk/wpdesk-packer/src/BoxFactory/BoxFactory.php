...
abstract class BoxFactory
{
     ...
     */
    public function append_all_boxes(\FlexibleShippingDhlExpressProVendor\WPDesk\Packer\Packer $boxpack)
    {
     ...
     * @param string $key .
     */
    public function append_single_box(\FlexibleShippingDhlExpressProVendor\WPDesk\Packer\Packer $boxpack, $key)
    {
     ...
     * @param array  $box .
     */
    protected function append_box(\FlexibleShippingDhlExpressProVendor\WPDesk\Packer\Packer $boxpack, $key, $box)
    {
        $newbox = new \FlexibleShippingDhlExpressProVendor\WPDesk\Packer\Box\BoxImplementation($box['length'], $box['width'], $box['height'], 0, $box['weight'], array('id' => $key, 'box' => $box));
