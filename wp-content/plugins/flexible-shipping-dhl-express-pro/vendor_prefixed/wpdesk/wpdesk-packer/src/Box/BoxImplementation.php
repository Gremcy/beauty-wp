...
namespace FlexibleShippingDhlExpressProVendor\WPDesk\Packer\Box;
...
class BoxImplementation extends \FlexibleShippingDhlExpressProVendor\WPDesk\Packer\Item\ItemImplementation implements \FlexibleShippingDhlExpressProVendor\WPDesk\Packer\Box
{
    /** @var float|null */
    private $max_weight;
    /** @var string */
